              ...
              <div className="flex gap-3">
                {event.photo_url && (
                  <div className="text-center">
                    <img src={event.photo_url} alt="Sebelum" loading="lazy" decoding="async" width={112} height={112} className="rounded-lg w-28 h-28 object-cover border" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                    <span className="text-[10px] text-muted-foreground mt-1 block">Sebelum</span>
                  </div>
                )}
                {event.photo_url_after && (
                  <div className="text-center">
                    <img src={event.photo_url_after} alt="Sesudah" loading="lazy" decoding="async" width={112} height={112} className="rounded-lg w-28 h-28 object-cover border" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
