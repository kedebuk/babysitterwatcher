        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-3">
            <div className="flex-1">
              ...
              {displayBeforePhoto ? (
                <div className="relative inline-block">
                  <img src={displayBeforePhoto} alt="Sebelum" loading="lazy" decoding="async" width={80} height={80} className="rounded-lg w-20 h-20 object-cover" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
            ...
            <div className="flex-1">
              ...
              {displayAfterPhoto ? (
                <div className="relative inline-block">
                  <img src={displayAfterPhoto} alt="Sesudah" loading="lazy" decoding="async" width={80} height={80} className="rounded-lg w-20 h-20 object-cover" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
