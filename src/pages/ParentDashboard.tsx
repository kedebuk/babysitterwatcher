                      ...
                      <CardContent className="p-3 flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {(event as any).photo_url && (
                            <img src={(event as any).photo_url} alt="Foto aktivitas" className="mt-2 rounded-lg w-24 h-24 object-cover cursor-pointer" onClick={() => window.open((event as any).photo_url, '_blank')} onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                          )}
